  		...
  		$('#dg').datagrid({
			...
			checkOnSelect:true,
  			...
  			toolbar: [{
						...
						text:'删除',
						handler: function(){
							$.messager.confirm('确认','删除用户会删除相应的评论，您确认想要删除吗？',function(r){   
								if(r){
									var rows = $('#dg').datagrid("getSelections");
										...
										$.post("Puser_delUser.action",{id:ids},function(reslut){
											if(reslut){
			...
			//ctrl键多选
			ctrlSelect:true,
		    url:'/pet/Puser_queryUser.action',
		    striped:true,
		    nowrap:true,
		    fitColums:true,
		    //分页工具栏
		    ...
		    columns:[[
		        ...
		        {field:'userpassword',title:'用户密码',width:200},
		        {field:'email',title:'用户邮箱',width:200},
		        {field:'',title:'编辑', width:80,
						formatter: function(value,row,index){
							return "<a href='Puser_searchUser_edit.action?userid="+row.userid+"'>编辑</a> ";
						}
		        }
		    ]] 
		}); 
