				...
				.datagrid(
						{
							...
							//ctrl键多选
							ctrlSelect : true,
							url : '/pet/Pcategory_findPet.action?sc=' + sc,
							striped : true,
							nowrap : true,
							fitColums : true,
							//分页工具栏
							...
							columns : [ [
									...
									},
									{
										...
										formatter : function(value, row, index) {
											return "<a href='Pcategory_searchCategory_editCategory.action?categoryid="
													+ row.categoryid + "'>编辑</a> ";
										}
									} ] ]
						});
